...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getGameCoordinates: () => (/* binding */ getGameCoordinates),\n/* harmony export */   mouse: () => (/* binding */ mouse)\n/* harmony export */ });\n/* harmony import */ var _camera__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./camera */ \"./client-src/camera.js\");\n/* harmony import */ var _network_network__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./network/network */ \"./client-src/network/network.js\");\n\r\n\r\n\r\nconst canvas = document.querySelector(\"canvas\");\r\n\r\nconst mouse = {\r\n    x: 0, /* clientX */\r\n    y: 0, /* clientY */\r\n    mouseX: 0,\r\n    mouseY: 0,\r\n    get tileX() { return this.mouseX / _camera__WEBPACK_IMPORTED_MODULE_0__.camera.zoom },\r\n    get tileY() { return this.mouseY / _camera__WEBPACK_IMPORTED_MODULE_0__.camera.zoom },\r\n    buttons: 0\r\n}\r\n\r\ncanvas.addEventListener('click', event => {\r\n    mouse.buttons = event.buttons;\r\n})\r\n\r\nfunction getGameCoordinates(clientX, clientY) {\r\n    mouse.x = clientX, mouse.y = clientY;\r\n\r\n    const rect = canvas.getBoundingClientRect();\r\n    const offsetX = clientX - rect.left + _camera__WEBPACK_IMPORTED_MODULE_0__.camera.x;\r\n    const offsetY = clientY - rect.top + _camera__WEBPACK_IMPORTED_MODULE_0__.camera.y;\r\n\r\n    mouse.mouseX = offsetX, mouse.mouseY = offsetY;\r\n\r\n    const gameX = offsetX / _camera__WEBPACK_IMPORTED_MODULE_0__.camera.zoom;\r\n    const gameY = offsetY / _camera__WEBPACK_IMPORTED_MODULE_0__.camera.zoom;\r\n\r\n    return { x: gameX, y: gameY };\r\n}\r\n\r\ncanvas.addEventListener('mousemove', event => {\r\n    const pos = getGameCoordinates(event.clientX, event.clientY);\r\n\r\n    document.getElementById(\"xy-display\").innerText = `XY: ${Math.floor(pos.x)},${Math.floor(pos.y)}`;\r\n\r\n    (0,_network_network__WEBPACK_IMPORTED_MODULE_1__.unloadInvisibleChunks)();\r\n    (0,_network_network__WEBPACK_IMPORTED_MODULE_1__.loadVisibleChunks)();\r\n})\n\n//# sourceURL=webpack://drawzone/./client-src/mouse.js?");
